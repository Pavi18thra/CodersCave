...
class Main {
    ...
    public static void main(String[] args) {
        ...
        Student student1 = new Student("66H0", "pavi", "rao");
        Student student2 = new Student("66H1", "taqi", "Smith");
        Student student3 = new Student("66H2", "Ram", "Saran");
        Student student4 = new Student("66H3", "Ramya", "Pandian");
